...
class IndexController extends AbstractActionController
{
	...
	//localhost:8161/jeerav1.2/service/index/register?name=asheesh&email=asheesh.sharma&password=123456&country_id=4&city_id=1
	public function registerAction()
    {
		$request = $this->getRequest();
		$postedValues = $this->getRequest()->getQuery();
	...
	//http://localhost:8161/jeerav1.2/service/index/login?email=asheesh.sharma&password=123456
    ...
    { 
		...
		if (!$result->isValid()) {	
			...
			$dataArr[0]['flag'] = "Success";
			$dataArr[0]['message'] = $set_secretcode;
			echo json_encode($dataArr);
			exit;
		}
	}
	//http://localhost:8161/jeerav1.2/service/index/loginaccess?email=asheesh.sharma@classicinformatics.com&accesstoken=214d9a3f22e8f2a8fb3631b6d20af603
	...
	//http://localhost:8161/jeerav1.2/service/index/logout?userId=2
	...
	public function verifyemailAction(){	
		...
		echo '<pre>'; print_r('dfvrf'.$key); die;
	}
	//http://asheesh.linuxstage/jeerav1.2/service/index/forgotPassword?email=asheesh.sharma@classicinformatics.com
	...
	public function sendPasswordResetMail($user_verification_key,$insertedRecoveryid,$emailId){
		...
		$body = $this->renderer->render('service/email/emailResetPassword.phtml', array('user_verification_key'=>$user_verification_key,'user_recoverId'=>$user_recoverId));
	...
	public function sendVerificationEmail($user_verification_key,$insertedUserId,$emailId){
		...
		$body = $this->renderer->render('service/email/emailVarification.phtml', array('user_verification_key'=>$user_verification_key,'user_insertedUserId'=>$user_insertedUserId));
